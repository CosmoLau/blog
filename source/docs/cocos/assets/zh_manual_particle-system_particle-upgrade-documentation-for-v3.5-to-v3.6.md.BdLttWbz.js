import{_ as n,c as a,o as s,a5 as p}from"./chunks/framework.CqnjdYks.js";const u=JSON.parse('{"title":"升级指南：粒子 从 v3.5.x 升级到 v3.6.0","description":"","frontmatter":{},"headers":[],"relativePath":"zh/manual/particle-system/particle-upgrade-documentation-for-v3.5-to-v3.6.md","filePath":"zh/manual/particle-system/particle-upgrade-documentation-for-v3.5-to-v3.6.md"}'),e={name:"zh/manual/particle-system/particle-upgrade-documentation-for-v3.5-to-v3.6.md"},i=p(`<h1 id="升级指南-粒子-从-v3-5-x-升级到-v3-6-0" tabindex="-1">升级指南：粒子 从 v3.5.x 升级到 v3.6.0 <a class="header-anchor" href="#升级指南-粒子-从-v3-5-x-升级到-v3-6-0" aria-label="Permalink to &quot;升级指南：粒子 从 v3.5.x 升级到 v3.6.0&quot;">​</a></h1><h2 id="cpu-粒子" tabindex="-1">CPU 粒子 <a class="header-anchor" href="#cpu-粒子" aria-label="Permalink to &quot;CPU 粒子&quot;">​</a></h2><p>v3.6.0 粒子系统新增了 instance 支持，粒子 shader particle-vs-legacy.chunk 需要做如下修改：</p><p>原来的 layout：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>in vec3 a_position; // center position</span></span>
