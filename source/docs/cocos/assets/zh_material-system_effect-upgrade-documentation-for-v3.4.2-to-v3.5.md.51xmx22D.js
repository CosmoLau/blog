import{_ as s,c as a,o as i,a4 as n}from"./chunks/framework.uQk9_EO2.js";const g=JSON.parse('{"title":"升级指南：Effect 从 v3.4.x 升级到 v3.5.0","description":"","frontmatter":{},"headers":[],"relativePath":"zh/material-system/effect-upgrade-documentation-for-v3.4.2-to-v3.5.md","filePath":"zh/material-system/effect-upgrade-documentation-for-v3.4.2-to-v3.5.md","lastUpdated":1712305443000}'),p={name:"zh/material-system/effect-upgrade-documentation-for-v3.4.2-to-v3.5.md"},l=n(`<h1 id="升级指南-effect-从-v3-4-x-升级到-v3-5-0" tabindex="-1">升级指南：Effect 从 v3.4.x 升级到 v3.5.0 <a class="header-anchor" href="#升级指南-effect-从-v3-4-x-升级到-v3-5-0" aria-label="Permalink to &quot;升级指南：Effect 从 v3.4.x 升级到 v3.5.0&quot;">​</a></h1><h2 id="宏标记和函数宏" tabindex="-1">宏标记和函数宏 <a class="header-anchor" href="#宏标记和函数宏" aria-label="Permalink to &quot;宏标记和函数宏&quot;">​</a></h2><p>宏标记和功能宏的效果语法已升级，为避免占用标准的 glsl 定义，项目中旧的 Cocos Shader 文件（*.effect）将自动升级，但如果您使用的是没有配套 *.meta 数据的外部 Cocos Shader 文件，或编写新的 Cocos Shader，则必须注意。</p><ul><li>宏标记的新语法：<code>#pragma define meta</code></li><li>函数宏的新语法：<code>#pragma define</code></li></ul><p>有关详细信息，请参阅 <a href="./../shader/macros#macro-tags">Cocos Shader 语法 - macro-tags</a>。</p><h2 id="模型级别的阴影偏移" tabindex="-1">模型级别的阴影偏移 <a class="header-anchor" href="#模型级别的阴影偏移" aria-label="Permalink to &quot;模型级别的阴影偏移&quot;">​</a></h2><p>在 v3.5 中我们支持对模型设置单独阴影偏移值，可以对简单或复杂曲面上的阴影效果进行详细控制。如果您有任何自定义的 effect 文件，您可能需要升级它们使阴影偏移值生效。</p><p>解决 <strong>effect</strong> 文件从v3.4.x，升级到 v3.5.0 后，shadowBias 不生效的问题。</p><blockquote><p><strong>注意</strong>：如果禁用灯光的阴影贴图，或者没有在顶点着色器上计算 <strong>CC_TRANSFER_SHADOW(pos)</strong> 则 <strong>忽略</strong> 该材质升级。</p></blockquote><h3 id="升级说明" tabindex="-1">升级说明 <a class="header-anchor" href="#升级说明" aria-label="Permalink to &quot;升级说明&quot;">​</a></h3><p>有 <strong>四个元素</strong> 要添加到效果文件中，如下所示：</p><ol><li><p>vs out varying 定义</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#if CC_RECEIVE_SHADOW</span></span>
