...
timeline
    ...
    2026.7.2 : 迁移到 Firefly 主题
```

# 2026.7.2

这天一大早，GitHub 给我发了两个高危漏洞的警告，正好我也因为 `fuwari` 仓库太久没有维护，一直想换到 `Firefly`，就顺水推舟花了点时间把这件事给做了。

::github{repo="CuteLeaf/Firefly"}

`Firefly` 虽师承 `fuwari`，但活跃的维护让其功能非常强大，可以说是完全体形态的 `fuwari`，我也对这个主题非常满意，感谢作者大大的维护。

不过这次的迁移比较仓促，还有很多主题自带的功能没能配置，暂时进行了隐藏，后续再慢慢加上。
